...
ENV VITE_API_URL=https://prod-api-gigsmanual.harx.ai/api
ENV VITE_REP_URL=https://prod-api-repcreationwizard.harx.ai/api
...
ENV VITE_API_URL_ONBOARDING=https://prod-api-companysearchwizard.harx.ai/api
